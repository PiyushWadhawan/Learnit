  ...
  return (
    ...
    <nav className="navbar navbar-expand-lg bg-light fixed-top">
        <div className="container-fluid">
            <Link className="navbar-brand hey" to='/' style={{color: 'green', textDecoration: 'none', fontWeight: 'bold'}}>learnIt!</Link>
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
                <ul className="navbar-nav">
                    <li className="nav-item dropdown">
                        <NavLink style={{color: 'black', textDecoration: 'none'}} to='/OurStory' className="nav-link">Our Story</NavLink>
                    </li>
