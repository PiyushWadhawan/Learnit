    ...
    <div className='container features'>
        <div className='row'>
            ...
            <div className='col-md-4'>
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRpvb1ritUaI2VsJ-YMQkBen-uM02J5hJILwQ&usqp=CAU" class="img-fluid" alt="..."/>
                <h2 style={{textAlign: "center"}}>Flexible schedule</h2>
                <p>Reschedule your Batch/Class at Your Convenience</p>
            </div>
            <div className='col-md-4'>
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTb5qOvF8MJdrsRzRSOw8hsrPS82vVxGl4MkQ&usqp=CAU" class="img-fluid" alt="..."/>
